<template>
  <div class="header">
    ...
    >
      ...
      <img
        src="https://images.unsplash.com/photo-1511876849877-f8d0d953d2e0?ixlib=rb-0.3.5&ixid=eyJhcHBfaWQiOjEyMDd9&s=a005647cf42ef9a8c66e1aed85ccc5ec&auto=format&fit=crop&w=3450&q=80"
  ...
  data () {
      return {
        ...
        links: [
            {
            name: "Profile",
            url: `/${this.user.username}/profile`,
            icon: `
